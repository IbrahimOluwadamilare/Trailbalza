...
<head>
    ...
    <meta name="description" content="TrailBlaza" />
    <meta name="keywords" content="TrailBlaza" />
    <meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=1">
    <!-- SITE TITLE -->
    <title>TrailBlaza - App Landing Page</title>
...
<body> 
    ...
    <div id="fullpage">
        ...
        <div class="wrap">
            ...
            <!-- Home IMAGE --><img src="images/landing.png" alt="Home">
            <!-- Features IMAGE --><img src="images/login.png" alt="Features">
            <!-- About IMAGE --><img src="images/chat.png" alt="About">
             <!--Video IMAGE <img src="http://placehold.it/232x420" alt="Video">
             Clients IMAGE <img src="http://placehold.it/232x420" alt="Clients">-->
            <!-- Screenshots IMAGE --><img src="images/landing.png" alt="Screenshots">
             <!--Pricing IMAGE <img src="http://placehold.it/232x420" alt="Pricing">-->
             <!--Download IMAGE --> <img src="images/register.png" alt="Download">
            <!-- Contact IMAGE --><img src="images/landing.png" alt="Contact">
            </div>
            <div id="hand"></div>
        </div>
        ...
        <div class="section" id="section5">
            <div class="wrap">
                ...
                <div class="screenshots-wrapper">
                    ...
                    <div class="slide" id="slide3" data-anchor="slide3"> <img src="images/landing.png" alt="screenshot4"> </div>
                    <div class="slide" id="slide1" data-anchor="slide1"> <img src="images/login.png" alt="screenshot1"> </div>
                    <div class="slide" id="slide2" data-anchor="slide2"> <img src="images/register.png" alt="screenshot2"> </div>
                    <div class="slide" id="slide3" data-anchor="slide3"> <img src="images/chat.png" alt="screenshot3"> </div>
